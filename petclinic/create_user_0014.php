...
if (isset($_POST['save'])) {
    ...
    $query = "INSERT INTO users_0014 (username_0014, password_0014, usertype_0014, fullname_0014) 
        VALUES ('$_POST[username_0014]', '$_POST[password_0014]', '$_POST[usertype_0014]', '$_POST[fullname_0014]')";
}
